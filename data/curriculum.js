...
const MODULOS = [
  ...
  },
  {
    ...
    color: '#fb8c00',
    libres: 2,
    desc: 'No sólo qué tecla: también cuándo',
    lecciones: [
      {
        id: 'r1',
        nombre: 'El pulso',
        ...
        bpm: 80,
        explicacion: {
          titulo: 'La música tiene latido',
          texto:
            'Toda canción tiene un <b>pulso</b>: un golpecito parejo que se repite, como el latido del corazón. Cuando movés el pie escuchando música, estás siguiendo el pulso.',
          tip: 'Escuchá la demostración y golpeá el pie al mismo tiempo 🦶',
        },
        demo: [
          { n: 'C4', d: 1 },
          { n: 'C4', d: 1 },
        ...
        practica: [
          { n: 'C4', d: 1, pista: 'Un golpe por cada latido' },
          { n: 'C4', d: 1 },
          { n: 'C4', d: 1 },
          { n: 'C4', d: 1 },
        ],
      ...
      },
      {
        ...
        bpm: 80,
        explicacion: {
          titulo: 'Una nota por pulso',
          texto:
            'La <b>negra</b> dura exactamente <b>un pulso</b>. Es la figura más común de toda la música: cuando contás "1, 2, 3, 4", cada número es una negra.',
          tip: 'Se escribe ♩ — una cabeza negra con palito 🖊️',
        },
        demo: [
          { n: 'C4', d: 1 },
          { n: 'D4', d: 1 },
      ...
      {
        id: 'r3',
        nombre: 'La blanca dura el doble',
        emoji: '♪',
        bpm: 80,
        explicacion: {
          titulo: 'Notas largas',
          texto:
            'La <b>blanca</b> dura <b>dos pulsos</b>: el doble que una negra. Mientras suena, vos contás "1, 2" antes de tocar la siguiente.',
          tip: 'Escuchá cómo las notas largas hacen que la música "respire" 🌬️',
        },
        demo: [
          { n: 'C4', d: 2 },
          { n: 'E4', d: 2 },
        ...
        practica: [
          { n: 'C4', d: 2, pista: 'Blanca: aguantá dos pulsos' },
          { n: 'E4', d: 2 },
          { n: 'G4', d: 1, pista: 'Ahora dos negras, más cortas' },
          { n: 'G4', d: 1 },
          { n: 'C5', d: 2 },
        ],
        evaluacion: [
      ...
      {
        id: 'r4',
        nombre: 'Las corcheas van rápido',
        emoji: '♫',
        bpm: 76,
        explicacion: {
          titulo: 'Dos por pulso',
          texto:
            'La <b>corchea</b> dura <b>medio pulso</b>: entran <b>dos</b> en el tiempo de una negra. Se cuentan "1 y 2 y 3 y 4 y", donde los números y los "y" son corcheas.',
          tip: 'Las corcheas son las que hacen que una canción suene movida 🏃',
        },
        demo: [
          { n: 'C4', d: 0.5 },
          { n: 'D4', d: 0.5 },
        ...
        practica: [
          { n: 'C4', d: 0.5, pista: 'Corcheas: rápido, dos por pulso' },
          { n: 'D4', d: 0.5 },
          { n: 'E4', d: 0.5 },
          { n: 'F4', d: 0.5 },
          { n: 'G4', d: 2, pista: 'Y ahora una blanca, bien larga' },
        ],
        evaluacion: [
          { n: 'C4', d: 0.5 },
          { n: 'D4', d: 0.5 },
      ...
      },
      {
        ...
        explicacion: {
          titulo: 'Prueba del módulo',
          texto:
            'Ya conocés las tres figuras: <b>corchea</b> (medio pulso), <b>negra</b> (un pulso) y <b>blanca</b> (dos pulsos). Esta melodía las mezcla a las tres.',
          tip: 'Cuando termines, probá el modo <b>🥁 Con ritmo</b> en Canciones 🎵',
        },
        demo: [
          { n: 'C4', d: 1 },
          { n: 'C4', d: 1 },
  ...
  {
    id: 'lectura',
    nombre: 'Leer partituras',
    emoji: '🎼',
    color: '#7c6df2',
    libres: 2,
    desc: 'Mirar el papel y saber qué tocar',
    partitura: true,
    lecciones: [
      {
        id: 'p1',
        ...
        bpm: 80,
        explicacion: {
          titulo: 'El pentagrama',
          texto:
            'La música se escribe sobre <b>cinco líneas</b>. Una nota puede estar <b>sobre una línea</b> o <b>en el espacio</b> entre dos. Cuanto más arriba está, más aguda suena.',
          tip: 'El dibujo raro del principio (𝄞) es la <b>clave de sol</b>: dice desde dónde se cuenta 🔑',
        },
        demo: [
          { n: 'E4', d: 1 },
          { n: 'G4', d: 1 },
        ...
        practica: [
          { n: 'E4', d: 1, pista: 'Primera línea, la de más abajo' },
          { n: 'G4', d: 1, pista: 'Segunda línea' },
          { n: 'B4', d: 1, pista: 'Tercera, la del medio' },
          { n: 'D5', d: 1, pista: 'Cuarta' },
          { n: 'F5', d: 1, pista: 'Quinta, la de más arriba' },
        ],
        evaluacion: [
          { n: 'E4', d: 1 },
          { n: 'G4', d: 1 },
      ...
      },
      {
        ...
        bpm: 80,
        explicacion: {
          titulo: 'Entre línea y línea',
          texto:
            'Entre las cinco líneas hay <b>cuatro espacios</b>. Las notas de los espacios son <b>Fa, La, Do y Mi</b>, de abajo hacia arriba.',
          tip: 'Se leen igual que las de las líneas: más arriba, más agudo 📈',
        },
        demo: [
          { n: 'F4', d: 1 },
          { n: 'A4', d: 1 },
        ...
        practica: [
          { n: 'F4', d: 1, pista: 'Primer espacio' },
          { n: 'A4', d: 1, pista: 'Segundo' },
          { n: 'C5', d: 1, pista: 'Tercero' },
          { n: 'E5', d: 1, pista: 'Cuarto' },
        ],
        evaluacion: [
          { n: 'F4', d: 1 },
          { n: 'A4', d: 1 },
      ...
      {
        id: 'p3',
        nombre: 'El Do del medio',
        emoji: '🔴',
        bpm: 80,
        explicacion: {
          titulo: 'La nota con rayita propia',
          texto:
            'El <b>Do central</b> no entra en el pentagrama: queda justo abajo, y por eso lleva una <b>rayita</b> atravesada. Esa rayita se llama <b>línea adicional</b>.',
          tip: 'Es el mismo Do que buscás en el teclado con el truco de las 2 negras 🎹',
        },
        demo: [
          { n: 'C4', d: 1 },
          { n: 'D4', d: 1 },
        ...
        practica: [
          { n: 'C4', d: 1, pista: 'Do central: abajo, con su rayita' },
          { n: 'D4', d: 1, pista: 'Re: justo debajo de la primera línea' },
          { n: 'E4', d: 1, pista: 'Mi: ya sobre la primera línea' },
          { n: 'C4', d: 2 },
        ],
        evaluacion: [
          { n: 'C4', d: 1 },
      ...
      {
        id: 'p4',
        nombre: 'La figura dice cuánto dura',
        emoji: '♩',
        bpm: 80,
        explicacion: {
          titulo: 'Hueca o rellena',
          texto:
            'La <b>forma</b> de la nota dice cuánto dura. La <b>negra</b> tiene la cabeza rellena y dura un pulso. La <b>blanca</b> la tiene hueca y dura dos. La <b>corchea</b> lleva una banderita y dura medio.',
          tip: 'Ya lo aprendiste de oído en el módulo de Ritmo; ahora lo ves escrito 👀',
        },
        demo: [
          { n: 'C4', d: 1 },
          { n: 'D4', d: 1 },
        ...
        practica: [
          { n: 'C4', d: 1, pista: 'Negra: cabeza rellena' },
          { n: 'D4', d: 1 },
          { n: 'E4', d: 2, pista: 'Blanca: cabeza hueca, dura el doble' },
          { n: 'E4', d: 0.5, pista: 'Corchea: con banderita, la mitad' },
          { n: 'F4', d: 0.5 },
          { n: 'G4', d: 2 },
        ],
        evaluacion: [
      ...
      {
        id: 'p5',
        nombre: 'Leer una melodía',
        emoji: '🏅',
        bpm: 76,
        explicacion: {
          titulo: 'Prueba del módulo',
          texto:
            'Ahora leés del papel: mirá la <b>altura</b> para saber qué tecla y la <b>figura</b> para saber cuánto dura. Esta melodía es el comienzo de <b>Estrellita</b>.',
          tip: 'Cuando termines, abrí cualquier canción: todas se ven escritas 🎵',
        },
        demo: [
          { n: 'C4', d: 1 },
          { n: 'C4', d: 1 },
