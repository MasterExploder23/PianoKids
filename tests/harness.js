...
const EXPOSED = [
  ...
  'Audio2', 'Ritmo', 'Partitura', 'modoCancion', 'MISIONES', 'misionEstado', 'HITOS', 'hitosCobrados', 'TEMAS', 'AVATARES', 'comprados', 'temaActivo', 'avatarActivo', 'COF',
];
const EXPOSED_FN = [
...
const PART = 'partitura.js'; // notacion real (v2.3)
...
function boot(opts = {}) {
  ...
  const datosJs =
    ...
    fs.readFileSync(path.join(ROOT, PART), 'utf8') + '\n' +
